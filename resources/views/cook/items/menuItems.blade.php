          ...
          <div class="col-5 col-1-575">
            <div class="menu-item-photo">
              ...
              @endauth
                ...
                <img class="img-responsive" width="250" height="150" onerror="this.onerror=null;this.src='/storage/public/menu/default/item.jpg';"

                @if(!($item->extension=='not found'))

                src= "/storage/public/menu/{{$food}}/{{$food}}{{$item->number}}.{{$item->extension}}"

                @else
                src='/storage/public/menu/default/item.jpg'
                @endif
