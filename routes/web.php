...
Route::prefix('home/cooking')->group(function(){
    ...
    Route::view('/','home.home')->name('cooking');
    Route::get('/menu',[c::class,'getMenu'])->name('cooking.menu');

    //login
    Route::view('/admin','login.admin')->name('admin');
    ...
    //page
    Route::view('/about','about.about')->name('cook.about');
    Route::view('/awards','awards.awards')->name('cook.awards');
    //category
